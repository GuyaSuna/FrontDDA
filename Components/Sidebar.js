...
const Sidebar = () => {
  return (
    ...
    //         </svg>
    //       </span>
    //       <span className="ml-2 text-sm tracking-wide truncate">Alta Clientes</span>
    //     </a>
    //   </li>
    //   <li>
    //     <a
    ...
    <div className="flex flex-col h-full p-3 w-72 dark:bg-gray-900 dark:text-gray-100 justify-between">
      <div className="space-y-3">
        ...
        <div className="flex-1">
          <ul className="pt-2 pb-4 space-y-1 text-sm">
            <li className="rounded-sm hover:bg-gray-800 dark:text-gray-50">
              <a
      ...
      <div className="flex items-end p-2 space-x-4 justify-start">
        <img
          src="https://media.licdn.com/dms/image/D4D03AQFXnf7PSVORQA/profile-displayphoto-shrink_200_200/0/1693490764387?e=1707350400&v=beta&t=U7FgEVm5Rv_dGwWVD1AAlErY5sVFneL1jKX1XGLmPfE"
          alt=""
          className="w-12 h-12 rounded-lg dark:bg-gray-500"
        />
        <div>
          <h2 className="text-lg font-semibold">Alejo Spinelli</h2>
