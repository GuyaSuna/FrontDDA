  ...
  return (
    <div>
      <div class="flex min-h-full flex-row bg-gray-100 text-gray-800">
        <aside class="sidebar w-auto -translate-x-full transform  transition-transform duration-150 ease-in md:translate-x-0 md:shadow-md">
          <Sidebar />
        </aside>
        <main className="display-flex min-h-screen w-full flex-col items-center justify-between pr-40 bg-slate-800">
